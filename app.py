...
def Api_connect():
    Api_Id = "AIzaSyCpBpsssKHk_YOM6yoKhMpo6z8dE4DMYsE"
...
client = pymongo.MongoClient("mongodb+srv://karthidb:karthimldata@cluster0.5ij3h.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# query = "create database youtube_data4"
...
def channels_table(channel_name_s):
      con = mysql.connector.connect(
            ...
            user = "root",
            password = "12345678",
            database = "youtube_data4"
      )
      cursor = con.cursor(buffered=True)

    #   query = "use youtube_data4"
    #   cursor.execute(query)
      ...
      for index,row in df_single_channel_detail.iterrows():
            ...
            try:
                ...
                message = f"Your Provided Channels Name {channel_name_s} is Already Exists"
                return message
...
def playlist_table(channel_name_s):
    ...
    #   cursor.execute(query)
      ...
      df_single_playlist_detail["PublishedAt"]=pd.to_datetime(df_single_playlist_detail["PublishedAt"])
...
def videos_table(channel_name_s):
    ...
    #   cursor.execute(query)
      ...
      df_single_videos_detail["Published_Date"]=pd.to_datetime(df_single_videos_detail["Published_Date"])
...
def comments_table(channel_name_s):
    ...
    #   cursor.execute(query)
      ...
      df_single_comments_detail["Comment_Published"]=pd.to_datetime(df_single_comments_detail["Comment_Published"])
...
if question=="1. All the videos and the Channel name":
    ...
    for index,row in df9.iterrows():
        ...
        q9.append(dict(channeltitle=channel_title,avgduration=average_duration_str))
    df1=pd.DataFrame(q9)
    st.write(df1)
